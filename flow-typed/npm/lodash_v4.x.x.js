...
// Edits(bryan): Re-typed indexers with type `id: string` to `id: string | number` because many
// of our object lookups are by id, which is typed as `number`.
...
declare module "lodash" {
  ...
  declare class Lodash {
    ...
    findLast<V, A, T: { [id: string | number]: A }>(
      object: T,
      predicate?: ?OPredicate<A, T>
    ): V;
    flatMap<T, U>(
    ...
    partition<V, A, T: { [id: string | number]: A }>(
      object: T,
      predicate?: OPredicate<A, T>
    ): [Array<V>, Array<V>];
    reduce<T, U>(
    ...
    reject<V: Object, A, T: { [id: string | number]: A }>(
      object?: ?T,
      predicate?: ?OPredicate<A, T>
    ): Array<V>;
    ...
    findKey<A, T: { [id: string | number]: A }>(
      object: T,
      predicate?: ?OPredicate<A, T>
    ): string | void;
    findKey<A, T: { [id: string | number]: A }>(
    ...
    findLastKey<A, T: { [id: string | number]: A }>(
      object: T,
      predicate?: ?OPredicate<A, T>
    ): string | void;
    findLastKey<A, T: { [id: string | number]: A }>(
