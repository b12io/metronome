...
function Icon({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
...
function ColoredCheck({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style, checkColor }) {
...
function RemoveCircle({ className = '', width = 16, height = 16, style, color = defaultColor, solid = 'true' }) {
  if (solid) {
    return (
...
function Minus({ className = '', width = 16, height = 16, style, color = defaultColor }) {
  return (
...
function Plus({ className = '', width = 16, height = 16, style, color = defaultColor }) {
  return (
    <svg className={className} width={width} height={height} style={style} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
...
function Gear({ className = '', width = 16, height = 16, style, color = defaultColor }) {
  return (
...
function ShoppingCart({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Team({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Briefcase({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Image({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Video({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Camera({ color = defaultColor, className = '', path, width = 16, height = 16, viewBox = '0 0 16 16', style }) {
  return (
...
function Award({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Client({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Testimonial({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Blog({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Announcement({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Export({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Link({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function Unlink({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function Todo({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function Calendar({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function CalendarThin({ color = defaultColor, className = '', width = 16, height = 16, style }) {
  return (
...
function QuestionCircle({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style, ...otherProps }) {
  return (
...
function Product({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
...
function BulletPoints({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
...
function ClearFormatting({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function StrikeThrough({ color = defaultColor, className = '', viewBox = '0 0 21 16', width = 21, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Underline({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Italic({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Bold({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function UnorderedList({ color = defaultColor, className = '', viewBox = '0 0 22 16', width = 22, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function OrderedList({ color = defaultColor, className = '', viewBox = '0 0 22 16', width = 22, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Tablet({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
...
function Mobile({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
...
function Close({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
...
function ImageUpload({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function AlignLeft({ color = defaultColor, viewBox = '0 0 16 16', width = 16, height = 16 }) {
  return (
...
function AlignRight({ color = defaultColor, viewBox = '0 0 16 16', width = 16, height = 16 }) {
  return (
    <svg width={width} height={height} viewBox={viewBox} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
      <g id="Demo" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
...
function AlignCenter({ color = defaultColor, viewBox = '0 0 16 16', width = 16, height = 16 }) {
  return (
    <svg width={width} height={height} viewBox={viewBox} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
      <g id="Demo" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
...
function AlignLeftV2({ color = defaultColor, width = 24, height = 22, viewBox = '0 0 24 22' }) {
  return (
...
function AlignCenterV2({ color = defaultColor, width = 25, height = 22, viewBox = '0 0 25 22' }) {
  return (
    <svg width={width} height={height} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="evenodd">
...
function AlignRightV2({ color = defaultColor, width = 25, height = 22, viewBox = '0 0 25 22' }) {
  return (
    <svg width={width} height={height} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="evenodd">
...
function AlignJustifyV2({ color = defaultColor, width = 25, height = 22, viewBox = '0 0 25 22' }) {
  return (
    <svg width={width} height={height} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="evenodd">
...
function Back({ width = 16, height = 16, viewBox = '0 0 16 16', color = defaultColor, ...other }) {
  return (<svg
    {...other}
    xmlns="http://www.w3.org/2000/svg"
    xmlnsXlink="http://www.w3.org/1999/xlink"
...
function CheckSelected({ width = 16, height = 16, viewBox = '0 0 16 16', color = defaultColor }) {
  return (
...
function CheckmarkCircle({ width = 16, height = 16, viewBox = '0 0 16 16', color = defaultColor }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox={viewBox}>
...
function CaseStudy({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function ContactInformation({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function CustomerFilled({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function Faq({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function Integration({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function Location({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function CheckBold({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function XBold({ color = defaultColor, className = '', path, viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Media({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 19, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function Project({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function HeaderFooter({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Duplicate({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function Delete({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function IncompleteStep({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Logout({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function Badge({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function B12Logo({ color = defaultColor, className = '', height = 16, width = 16, viewBox = '0 0 16 16', style }) {
  return (
...
function Key({ color = defaultColor, className = '', viewBox = '0 0 16 16', width = 16, height = 16, style }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Animations({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
...
function Import({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
...
function AddCustomer({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width={width} height={height} className={className} style={style}>
...
function CaretDown({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
...
function Availability({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      style={style}
      className={className}
...
function CalendarEvent({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      style={style}
      className={className}
...
function Payments({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      style={style}
      className={className}
...
function Service({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      width={width}
      height={height}
...
function Repeat({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      style={style}
      className={className}
...
function Email({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      style={style}
      className={className}
...
function MagicWand({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      style={style}
      className={className}
...
function User({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      style={style}
      className={className}
...
function Layout({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      style={style}
      className={className}
...
function Code({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      style={style}
      className={className}
...
function Section({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      style={style}
      className={className}
...
function Tag({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      style={style}
      className={className}
...
function Welcome({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      style={style}
      className={className}
...
function Chat({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      style={style}
      className={className}
...
function Globe({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      style={style}
      className={className}
...
function At({ color = defaultColor, className = '', style, width = 16, height = 16 }) {
  return (
    <svg
      style={style}
      className={className}
...
function BlogPost({ className = '', width = 16, height = 16, viewBox = '0 0 16 16', style, color = defaultColor }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function MenuItems({ className = '', width = 16, height = 16, viewBox = '0 0 16 16', style, color = defaultColor }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
...
function Popup({ className = '', width = 16, height = 16, viewBox = '0 0 16 16', style, color = defaultColor }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function Testimonials({ className = '', width = 16, height = 16, viewBox = '0 0 16 16', style, color = defaultColor }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function Chart({ className = '', width = 16, height = 16, viewBox = '0 0 16 16', style, color = defaultColor }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} style={style} xmlns="http://www.w3.org/2000/svg">
      <g fillRule="nonzero" fill={color}>
...
function Sidebar({ className = '', width = 16, height = 16, viewBox = '0 0 16 16', color = defaultColor }) {
  return (
...
function Palette({ className = '', width = 16, height = 16, viewBox = '0 0 16 16', color = defaultColor }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width={width} height={height} viewBox={viewBox}>
...
function Lightbox({ className = '', width = 16, height = 16, color = defaultColor }) {
  return (
...
function Filter({ className = '', width = 16, height = 16, color = defaultColor }) {
  return (
...
function Slider({ className = '', width = 16, height = 16, color = defaultColor }) {
  return (
...
function Flash({ className = '', color = defaultColor, width = '11', height = '16', viewBox = '0 0 11 16' }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function Dashboard({ className = '', color = defaultColor, width = '16', height = '16', viewBox = '0 0 16 16' }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
...
function Guides({ className = '', color = defaultColor, width = '16', height = '16', viewBox = '0 0 16 16' }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
      <g fill={color} fillRule="nonzero">
...
function Article({ className = '', color = defaultColor, width = '16', height = '16', viewBox = '0 0 16 16' }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
...
function Pulse({ className = '', color = defaultColor, width = '16', height = '16', viewBox = '0 0 16 16' }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
...
function Edit({ className = '', color = defaultColor, width = '16', height = '16', viewBox = '0 0 16 16' }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
...
function ContentApproved({ className = '', color = defaultColor, width = '16', height = '16' }) {
  return (
...
function Dragger({ className = '', width = 16, height = 16, viewBox = '0 0 16 16', color = defaultColor }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width={width} height={height} viewBox={viewBox}>
      <g fill="none">
        <g fill={color}>
...
function PaperClip({ className = '', width = 16, height = 16, viewBox = '0 0 16 16', color = defaultColor }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width={width} height={height} viewBox={viewBox}>
      <g fill={color}>
...
function Invoicing({ className = '', width = 16, height = 16, viewBox = '0 0 16 16', color = defaultColor }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width={width} height={height} viewBox={viewBox}>
...
function Banking({ className = '', width = 16, height = 16, viewBox = '0 0 16 16', color = defaultColor }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width={width} height={height} viewBox={viewBox}>
      <g fill={color}>
...
function Checkbox({ className = '', width = '16', height = '16', color = defaultColor }) {
  return (
...
function Circle({ width = 16, height = 16, viewBox = '0 0 16 16', color = defaultColor }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox={viewBox}>
...
function SolidCircle({ className = '', width = 16, height = 16, viewBox = '0 0 16 16', color = defaultColor }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
...
function Bank({ className = '', width = 16, height = 16, viewBox = '0 0 16 16', color = defaultColor }) {
  return (
...
function Card({ className = '', width = '21', height = '14', viewBox = '0 0 21 14', color = defaultColor }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
...
function Contract({ className = '', width = '17', height = '16', viewBox = '0 0 17 16', color = defaultColor }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
...
function MinusCircle({ className = '', width = '16', height = '16', viewBox = '0 0 16 16', color = defaultColor }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
...
function RepeatCircle({ className = '', width = '16', height = '16', viewBox = '0 0 16 16', color = defaultColor }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
...
function BadgeCard({ className = '', width = '16', height = '16', viewBox = '0 0 16 16', color = defaultColor }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
...
function HeadphonesMic({ className = '', width = '16', height = '16', color = defaultColor }) {
  return (
...
function LayoutAlternative({ className = '', width = '16', height = '16', color = '#766bff', viewBox = '0 0 16 16' }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
      <path fill={color} d="M9 10v5c0 .552-.448 1-1 1H1C.448001 16 6.4e-7 15.552 6.1e-7 15L4e-7 10C3.7e-7 9.448.448 9 1 9h7c.552 0 1 .448 1 1Z" />
      <path fill={color} d="M16 10v5c0 .552-.448 1-1 1h-3c-.552 0-1-.448-1-1v-5c0-.552.448-1 1-1h3c.552 0 1 .448 1 1Z" />
      <path fill={color} d="M6 1v5c0 .552-.448 1-1 1H1C.448 7 2.4e-7 6.552 2.2e-7 6L0 1C-2e-8 .448001.448 6.4e-7 1 6.1e-7l4-1.7e-7C5.552 4e-7 6 .448 6 1Z" />
      <path fill={color} d="M16 1v5c0 .552-.448 1-1 1H9c-.552 0-1-.448-1-1V1C8 .448 8.448 2.9e-7 9 2.6e-7L15 0c.552-2e-8 1 .448 1 1Z" />
    </svg>
  )
}

function GlobeAlternative({ className = '', width = '16', height = '16', color = '#766bff', viewBox = '0 0 16 16' }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
      <path fill={color} d="M10.7784 7.45981c.0716 0 .1402-.02989.1902-.08287.05-.05299.0771-.12458.0753-.19855-.0522-2.10185-.4433-3.86693-.9881-5.11618-.27202-.62385-.58704-1.129795-.92644-1.484111C8.79248.22642 8.40703 0 8 0c-.40703 0-.79248.22642-1.12936.578099-.3394.354316-.65442.860261-.92645 1.484111-.54475 1.24925-.93593 3.01433-.98809 5.11618-.00183.07397.02532.14556.0753.19855.04999.05298.11856.08287.19017.08287h5.55683Z" />
      <path fill={color} d="M5.52623.749563c.06506-.097103.06269-.226329-.00589-.320812-.06859-.094482-.18799-.13302-.29643-.095673C2.35044 1.32273.214341 3.9648.00062993 7.16657c-.00506415.07587.02057517.15051.07079917.20611.0502239.05559.1205269.08715.1941319.08715H3.66141c.1427 0 .25988-.11651.26537-.26384.10205-2.74147.71479-5.12613 1.59945-6.446427Z" />
      <path fill={color} d="M.265561 8.54019c-.073605 0-.143908.03157-.1941319.08716-.050224.0556-.07586332.13023-.07079916.2061C.214341 12.0352 2.35044 14.6773 5.22391 15.6669c.10844.0374.22784-.0011.29643-.0956.06858-.0945.07095-.2237.00589-.3208-.88466-1.3203-1.4974-3.705-1.59945-6.44647-.00549-.14733-.12267-.26384-.26537-.26384H.265561Z" />
      <path fill={color} d="M10.7761.333078c-.1085-.037347-.2279.001191-.2964.095673-.0686.094483-.071.223709-.0059.320812.8851 1.321047 1.4974 3.600067 1.5994 6.446037.0053.14749.1225.26423.2654.26423h3.3958c.0736 0 .1439-.03156.1942-.08715.0502-.0556.0758-.13024.0708-.20611-.2137-3.20177-2.3498-5.84384-5.2233-6.833492Z" />
      <path fill={color} d="M15.9994 8.83345c.005-.07587-.0206-.1505-.0708-.2061-.0503-.05559-.1206-.08716-.1942-.08716h-3.3958c-.1427 0-.2599.11651-.2654.26384-.102 2.74147-.7148 5.12617-1.5994 6.44647-.0642.0957-.0629.2228.0032.3171.0661.0942.1825.1352.2906.1021 2.8869-.8838 5.0185-3.6409 5.2318-6.83625Z" />
      <path fill={color} d="M5.22157 8.54019c-.07161 0-.14018.02988-.19017.08287-.04998.05299-.07713.12458-.0753.19855.05216 2.10189.44334 3.86689.98809 5.11619.27203.6238.58705 1.1298.92645 1.4841C7.20752 15.7736 7.59297 16 8 16c.40703 0 .79248-.2264 1.12936-.5781.3394-.3543.65442-.8603.92644-1.4841.5448-1.2493.9359-3.0143.9881-5.11619.0018-.07397-.0253-.14556-.0753-.19855-.05-.05299-.1186-.08287-.1902-.08287H5.22157Z" />
    </svg>
  )
}
...
function History({ className = '', width = '16', height = '16', color = '#84839C', viewBox = '0 0 18 18' }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M8.99988 5.36719V9.00355L11.909 11.9126"
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
      ...
      />
      <path
        d="M2.42984 1.10156L1.89966 5.31756L6.03929 4.1641"
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M1.89964 5.31423C2.80087 3.57807 4.30697 2.23228 6.13319 1.5313C7.95941 0.83032 9.97918 0.822736 11.8106 1.50998C13.642 2.19723 15.1582 3.53167 16.0725 5.26101C16.9867 6.99035 17.2357 8.99473 16.7723 10.8952C16.3088 12.7956 15.1652 14.4604 13.5575 15.5748C11.9499 16.6892 9.98963 17.176 8.04741 16.9431C6.10519 16.7101 4.31562 15.7737 3.01705 14.3108C1.71848 12.8478 1.0009 10.9598 1 9.00368"
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function Hand({ className = '', width = '17', height = '18', color = '#84839C', viewBox = '0 0 17 18' }) {
  return (
    <svg className={className} width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M7.04773 7.85587V2.33305C7.04773 1.59683 7.64457 1 8.38081 1C9.11698 1 9.71382 1.59683 9.71382 2.33305V7.85587"
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M9.71411 7.85192V3.09087C9.71411 2.35464 10.311 1.75781 11.0472 1.75781C11.7834 1.75781 12.3802 2.35464 12.3802 3.09087V8.61368"
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M12.3802 7.09402V5.38005C12.3802 4.64381 12.9771 4.04696 13.7133 4.04696C14.4496 4.04696 15.0464 4.64381 15.0464 5.38005V12.0404C15.0464 14.7778 12.8273 16.9969 10.0898 16.9969H7.48179C6.94154 16.9969 6.4042 16.9181 5.88674 16.7628C4.00937 16.1996 2.5682 14.688 2.09507 12.786L1.03337 8.51783C0.98135 8.30865 0.990301 8.08903 1.05916 7.8848C1.40104 6.87106 2.83015 6.85782 3.19077 7.86507L4.38179 11.1918V3.85648C4.38179 3.12026 4.97861 2.52344 5.71482 2.52344C6.45104 2.52344 7.04789 3.12026 7.04789 3.85648V5.57049"
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function Undo({ className = '', width = '16', height = '16', color = '#84839C', viewBox = '0 0 16 16' }) {
  return (
    <svg width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M10.2764 16L2.28347 16C1.98063 16 1.69019 15.8797 1.47605 15.6656C1.26191 15.4514 1.14161 15.161 1.14161 14.8581C1.14161 14.5553 1.26191 14.2649 1.47605 14.0507C1.69019 13.8366 1.98063 13.7163 2.28347 13.7163L10.2764 13.7163C11.185 13.7163 12.0563 13.3554 12.6987 12.713C13.3411 12.0705 13.702 11.1992 13.702 10.2907C13.702 9.38221 13.3411 8.5109 12.6987 7.86849C12.0563 7.22607 11.185 6.86516 10.2765 6.86516L3.89805 6.86516L6.51632 9.48344C6.72432 9.69879 6.83941 9.98723 6.83681 10.2866C6.83421 10.586 6.71412 10.8724 6.50241 11.0841C6.2907 11.2958 6.00431 11.4159 5.70492 11.4185C5.40553 11.4211 5.1171 11.306 4.90174 11.098L0.33432 6.5306C0.120256 6.31647 8.71947e-07 6.02608 8.98417e-07 5.72331C9.24887e-07 5.42053 0.120256 5.13014 0.334321 4.91601L4.90174 0.348596C5.00707 0.239537 5.13307 0.152547 5.27238 0.0927043C5.41169 0.0328603 5.56153 0.00136043 5.71314 4.34148e-05C5.86476 -0.0012736 6.01511 0.027618 6.15544 0.0850311C6.29577 0.142444 6.42326 0.227231 6.53048 0.334443C6.63769 0.441655 6.72247 0.569145 6.77989 0.709474C6.8373 0.849805 6.86619 1.00016 6.86487 1.15178C6.86356 1.30339 6.83206 1.45323 6.77221 1.59254C6.71237 1.73185 6.62538 1.85785 6.51632 1.96318L3.89805 4.58145L10.2765 4.58145C11.7906 4.58145 13.2428 5.18296 14.3135 6.25366C15.3842 7.32436 15.9857 8.77653 15.9857 10.2907C15.9857 11.8049 15.3842 13.2571 14.3135 14.3278C13.2428 15.3985 11.7906 16 10.2764 16Z"
        fill={color}
      />
    </svg>
  )
...
function Redo({ className = '', width = '16', height = '16', color = '#84839C', viewBox = '0 0 16 16' }) {
  return (
    <svg width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M5.70928 16L13.7023 16C14.0051 16 14.2955 15.8797 14.5097 15.6656C14.7238 15.4514 14.8441 15.161 14.8441 14.8581C14.8441 14.5553 14.7238 14.2649 14.5097 14.0507C14.2955 13.8366 14.0051 13.7163 13.7023 13.7163L5.70928 13.7163C4.80076 13.7163 3.92945 13.3554 3.28704 12.713C2.64462 12.0705 2.28371 11.1992 2.28371 10.2907C2.28371 9.38221 2.64462 8.5109 3.28703 7.86849C3.92945 7.22607 4.80076 6.86516 5.70927 6.86516L12.0877 6.86516L9.4694 9.48344C9.26141 9.69879 9.14631 9.98723 9.14891 10.2866C9.15152 10.586 9.2716 10.8724 9.48331 11.0841C9.69502 11.2958 9.98141 11.4159 10.2808 11.4185C10.5802 11.4211 10.8686 11.306 11.084 11.098L15.6514 6.5306C15.8655 6.31647 15.9857 6.02608 15.9857 5.72331C15.9857 5.42053 15.8655 5.13014 15.6514 4.91601L11.084 0.348596C10.9787 0.239537 10.8527 0.152547 10.7133 0.0927043C10.574 0.0328603 10.4242 0.00136043 10.2726 4.34148e-05C10.121 -0.0012736 9.97061 0.027618 9.83028 0.0850311C9.68995 0.142444 9.56246 0.227231 9.45525 0.334443C9.34804 0.441655 9.26325 0.569145 9.20584 0.709474C9.14842 0.849805 9.11953 1.00016 9.12085 1.15178C9.12217 1.30339 9.15367 1.45323 9.21351 1.59254C9.27335 1.73185 9.36034 1.85785 9.4694 1.96318L12.0877 4.58145L5.70927 4.58145C4.19508 4.58145 2.74291 5.18296 1.67221 6.25366C0.601513 7.32436 1.72094e-06 8.77653 1.85332e-06 10.2907C1.98569e-06 11.8049 0.601513 13.2571 1.67221 14.3278C2.74291 15.3985 4.19508 16 5.70928 16Z"
        fill={color}
      />
    </svg>
  )
...
function ZoomIn({ className = '', width = '16', height = '16', color = '#84839C', viewBox = '0 0 16 16' }) {
  return (
    <svg width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M9.5 8H8V9.5C8 9.63261 7.94732 9.75979 7.85355 9.85355C7.75979 9.94732 7.63261 10 7.5 10H6.5C6.36739 10 6.24021 9.94732 6.14645 9.85355C6.05268 9.75979 6 9.63261 6 9.5V8H4.5C4.36739 8 4.24021 7.94732 4.14645 7.85355C4.05268 7.75979 4 7.63261 4 7.5V6.5C4 6.36739 4.05268 6.24021 4.14645 6.14645C4.24021 6.05268 4.36739 6 4.5 6H6V4.5C6 4.36739 6.05268 4.24021 6.14645 4.14645C6.24021 4.05268 6.36739 4 6.5 4H7.5C7.63261 4 7.75979 4.05268 7.85355 4.14645C7.94732 4.24021 8 4.36739 8 4.5V6H9.5C9.63261 6 9.75979 6.05268 9.85355 6.14645C9.94732 6.24021 10 6.36739 10 6.5V7.5C10 7.63261 9.94732 7.75979 9.85355 7.85355C9.75979 7.94732 9.63261 8 9.5 8Z"
        fill={color}
      />
      <path
        d="M7 14C5.61553 14 4.26216 13.5895 3.11101 12.8203C1.95987 12.0511 1.06266 10.9579 0.532846 9.67879C0.00303304 8.3997 -0.13559 6.99224 0.134506 5.63437C0.404603 4.2765 1.07129 3.02922 2.05026 2.05026C3.02922 1.07129 4.2765 0.404603 5.63437 0.134506C6.99224 -0.13559 8.3997 0.00303304 9.67879 0.532846C10.9579 1.06266 12.0511 1.95987 12.8203 3.11101C13.5895 4.26216 14 5.61553 14 7C13.9979 8.85587 13.2597 10.6351 11.9474 11.9474C10.6351 13.2597 8.85587 13.9979 7 14ZM7 2C6.0111 2 5.0444 2.29325 4.22215 2.84265C3.39991 3.39206 2.75904 4.17296 2.38061 5.08659C2.00217 6.00022 1.90315 7.00555 2.09608 7.97545C2.289 8.94536 2.76521 9.83627 3.46447 10.5355C4.16373 11.2348 5.05465 11.711 6.02455 11.9039C6.99446 12.0969 7.99979 11.9978 8.91342 11.6194C9.82705 11.241 10.6079 10.6001 11.1574 9.77785C11.7068 8.95561 12 7.98891 12 7C11.9984 5.67441 11.4711 4.40356 10.5338 3.46622C9.59645 2.52889 8.3256 2.00159 7 2Z"
        fill={color}
      />
      <path
        d="M15.707 14.2914L13.314 11.8984C12.9035 12.4269 12.4285 12.9019 11.9 13.3124L14.293 15.7054C14.4816 15.8876 14.7342 15.9884 14.9964 15.9861C15.2586 15.9838 15.5094 15.8787 15.6948 15.6933C15.8803 15.5078 15.9854 15.257 15.9877 14.9948C15.99 14.7326 15.8892 14.48 15.707 14.2914Z"
        fill={color}
      />
    </svg>
  )
...
function ZoomOut({ className = '', width = '16', height = '16', color = '#84839C', viewBox = '0 0 16 16' }) {
  return (
    <svg width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M4.5 6H9.5C9.63261 6 9.75979 6.05268 9.85355 6.14645C9.94732 6.24021 10 6.36739 10 6.5V7.5C10 7.63261 9.94732 7.75979 9.85355 7.85355C9.75979 7.94732 9.63261 8 9.5 8H4.5C4.36739 8 4.24021 7.94732 4.14645 7.85355C4.05268 7.75979 4 7.63261 4 7.5V6.5C4 6.36739 4.05268 6.24021 4.14645 6.14645C4.24021 6.05268 4.36739 6 4.5 6Z"
        fill={color}
      />
      <path
        d="M7 14C5.61553 14 4.26216 13.5895 3.11101 12.8203C1.95987 12.0511 1.06266 10.9579 0.532846 9.67879C0.00303304 8.3997 -0.13559 6.99224 0.134506 5.63437C0.404603 4.2765 1.07129 3.02922 2.05026 2.05026C3.02922 1.07129 4.2765 0.404603 5.63437 0.134506C6.99224 -0.13559 8.3997 0.00303304 9.67879 0.532846C10.9579 1.06266 12.0511 1.95987 12.8203 3.11101C13.5895 4.26216 14 5.61553 14 7C13.9979 8.85587 13.2597 10.6351 11.9474 11.9474C10.6351 13.2597 8.85587 13.9979 7 14ZM7 2C6.0111 2 5.0444 2.29325 4.22215 2.84265C3.39991 3.39206 2.75904 4.17296 2.38061 5.08659C2.00217 6.00022 1.90315 7.00555 2.09608 7.97545C2.289 8.94536 2.76521 9.83627 3.46447 10.5355C4.16373 11.2348 5.05465 11.711 6.02455 11.9039C6.99446 12.0969 7.99979 11.9978 8.91342 11.6194C9.82705 11.241 10.6079 10.6001 11.1574 9.77785C11.7068 8.95561 12 7.98891 12 7C11.9984 5.67441 11.4711 4.40356 10.5338 3.46622C9.59645 2.52889 8.3256 2.00159 7 2Z"
...
function RotateLeft({ className = '', width = '14', height = '15', color = '#84839C', viewBox = '0 0 14 15' }) {
  return (
    <svg width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M1.66675 5.33594H9.00008C9.36827 5.33594 9.66675 5.63442 9.66675 6.0026V13.3359C9.66675 13.7041 9.36827 14.0026 9.00008 14.0026H1.66675C1.29855 14.0026 1.00008 13.7041 1.00008 13.3359V6.0026C1.00008 5.63442 1.29855 5.33594 1.66675 5.33594Z"
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M9.00016 1L7.3335 2.66667C7.58236 2.66667 8.24009 2.66667 8.99987 2.66667C10.8408 2.66667 12.3335 4.15905 12.3335 6V7.33333"
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function RotateRight({ className = '', width = '14', height = '15', color = '#84839C', viewBox = '0 0 14 15' }) {
  return (
    <svg width={width} height={height} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M11.6667 5.33594H4.33341C3.96523 5.33594 3.66675 5.63442 3.66675 6.0026V13.3359C3.66675 13.7041 3.96523 14.0026 4.33341 14.0026H11.6667C12.0349 14.0026 12.3334 13.7041 12.3334 13.3359V6.0026C12.3334 5.63442 12.0349 5.33594 11.6667 5.33594Z"
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M4.33333 1L6 2.66667C5.75113 2.66667 5.09341 2.66667 4.33363 2.66667C2.49267 2.66667 1 4.15905 1 6V7.33333"
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function Crop({ className = '', width = '16', height = '16', color = '#84839C' }) {
  return (
    <svg width={width} height={height} fill="none" xmlns="http://www.w3.org/2000/svg">
      <g fill={color}>
        <path d="M10 13h3v3h-3zM13 9V2H6V0H3v2H0v3h10v4H6V6H3v6h13V9z"></path>
      </g>
    </svg>
  )
}
...
function FlipX({ className = '', width = '16', height = '16', color = '#84839C' }) {
  return (
    <svg width={width} height={height} fill="none" xmlns="http://www.w3.org/2000/svg">
      <g fill={color}>
        <path d="M7 0h2v16H7z" />
        <path d="M5 4v8H0zM11 4v8h5z"></path>
      </g>
    </svg>
  )
}
...
function FlipY({ className = '', width = '16', height = '16', color = '#84839C' }) {
  return (
    <svg width={width} height={height} fill="none" xmlns="http://www.w3.org/2000/svg">
      <g fill={color}>
        <path d="M0 7h16v2H0z" />
        <path d="M12 5H4V0zM12 11H4v5z"></path>
      </g>
    </svg>
  )
}
...
export {
  Check, ColoredCheck, Checkmark, Lock, Notice, Disabled, Help, Search, Draggable,
