...
function TextArea ({label = '', value = '', placeholder = '', rows = 5, hasFeedback = false, hasError = false, resizable = true, counter = '', onUpdate = () => {}, onFocus = () => {}, onBlur = () => {}, contentHeight = false, disabled = false}) {
