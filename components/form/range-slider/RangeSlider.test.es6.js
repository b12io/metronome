...
it('should render range slider component', () => {
  const component = mount(
    <RangeSlider label="Label" value="10" onChange={(value) => {}} />
  )
...
it('should render max, min, center captions', () => {
  ...
  expect(
    component.find('.ds-form-range-slider__caption-item').at(0).text()
  ).toBe('Left')
  expect(
    component.find('.ds-form-range-slider__caption-item').at(1).text()
  ).toBe('Center')
  expect(
    component.find('.ds-form-range-slider__caption-item').at(2).text()
  ).toBe('Right')
})
...
it('should call onChange on input value change', () => {
  ...
  const component = mount(
    <RangeSlider label="Label" value="10" onChange={onChange} />
  )
