...
it('should check first option', () => {
  ...
  />)
  component.find('.ds-checkbox-select__label').simulate('click')
  component.find('.ds-checkbox-select__item').at(0).find('Checkbox').props().onChange()
...
it('should define selected and disabled options when passed', () => {
  ...
  />)
  component.find('.ds-checkbox-select__label').simulate('click')
  expect(component.find('.ds-checkbox-select__item').at(0).find('Checkbox').props().checked).toBeTruthy()
  expect(component.find('.ds-checkbox-select__item').at(1).find('Checkbox').props().checked).toBeTruthy()
  expect(component.find('.ds-checkbox-select__item').at(1).find('Checkbox').props().disabled).toBeTruthy()
  expect(component.find('.ds-checkbox-select__item').at(2).find('Checkbox').props().disabled).toBeTruthy()
  component.update()
  expect(component.find('.ds-checkbox-select__label').text()).toBe('Item 1, Item 2')
})
...
it('should render unselectedLabel when no options selected', () => {
  ...
  expect(component.find('.ds-checkbox-select__label').text()).toBe('Filter by price')
})
...
it('should preserve label when `selectedLabel` and custom label is passed', () => {
  ...
  expect(component.find('.ds-checkbox-select__item').at(1).find('Checkbox').props().checked).toBeTruthy()
  component.update()
  expect(component.find('.ds-checkbox-select__label').text()).toBe('Custom Label')
})
