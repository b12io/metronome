...
class TextField extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      >
        {this.props.label && (
          <div className="ds-control-label">{this.props.label}</div>
        )}
        <div
          className={classnames({
        ...
        >
          ...
          {this.props.color && (
            <div className="ds-form-control-color-picker__container">
              <div
            ...
            <React.Fragment>
              ...
              {this.props.success &&
                (this.props.successIcon || (
                  <Notice className="feedback-icon" color="#8FC980" />
                ))}
              {this.props.error && (
                <Notice className="feedback-icon" color="#F05E5E" />
              )}
              {this.props.searchIcon && (
                <Search className="search-icon" color="#ccc" />
              )}
            </React.Fragment>
          )}
        </div>
        ...
        {!isEmpty(this.props.info) && (
          <div className="ds-form-group__help-text">
            ...
            <span className="ds-form-group__info-text">{this.props.info}</span>
          </div>
        )}
      </div>
    )
