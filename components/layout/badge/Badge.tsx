...
import { CloseMedia } from "../../Icons.es6";
...
function Badge({
  ...
  return <div className={classNames} {...otherProps}>
      ...
      {hasRemoveIcon && <div className="ds-badge__remove-icon" onClick={onRemoveClick}>
          <CloseMedia color={filled ? '#ffffff' : '#808080'} width="8" height="8" viewBox="0 0 8 8" />
        </div>}
    </div>;
}
