...
type Props = {
  ...
  disabled: boolean;
  children?: Node;
  handleClick: (arg0: React.SyntheticEvent<HTMLButtonElement>) => void | Promise<void>;
  icon: Element<"svg"> | null | undefined;
  label: string;
  value: string;
  selected: boolean;
  hasImage: boolean;
...
function Card({
  ...
  })} disabled={disabled} onClick={handleClick} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
