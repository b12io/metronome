...
it('should have title text', () => {
  ...
  expect(component.find('.ds-content-block__header-title h4').exists()).toBe(
    true
  )
})
...
it('should show action button', () => {
  const component = shallow(
    <BlockTitle
      label="I am a title"
      button={<Button label="I am a button" small />}
    />
  )
...
it('should have description text', () => {
  const component = shallow(
    <BlockTitle label="I am a title" description="I am a description" />
  )
  expect(component.find('.ds-content-block__header-description').exists()).toBe(
    true
  )
})
