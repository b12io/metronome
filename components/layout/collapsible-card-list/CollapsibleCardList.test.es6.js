...
beforeEach(() => {
  component = shallow(
    <CollapsibleCardList>
      <CollapsibleCardListItem label="Label 1">
        <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam,
          odio.
        </p>
      </CollapsibleCardListItem>
      <CollapsibleCardListItem label="Label 2">
        <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam,
          odio.
        </p>
      </CollapsibleCardListItem>
      <CollapsibleCardListItem label="Label 3">
        <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam,
          odio.
        </p>
...
it('should render component with three children items', function () {
  ...
  expect(
    component
      .find('CollapsibleCardListItem')
      .some((item) => item.props().isActive)
  ).toBeFalsy()
})
...
it('should switch activeIndex on CollapsibleCardListItem click', () => {
  ...
  component.update()
  expect(
    component.find('CollapsibleCardListItem').at(1).props().isActive
  ).toBeTruthy()
})
