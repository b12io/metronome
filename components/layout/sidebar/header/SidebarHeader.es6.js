      ...
      <Fragment>
        <div className="ds-sidebar__header">
          <div className="ds-sidebar__header-back">
            {showLogo && (
              <svg
                className="ds-sidebar__header-logo"
                id="b12-logo"
                viewBox="0 0 179.8 79.2"
        ...
        {tabbedNavigation && (
          <div className="ds-sidebar__tabbed-nav">{tabbedNavigation}</div>
        )}
      </Fragment>
    )
  }
...
SidebarHeader.propTypes = {
  ...
  actionIcon: PropTypes.oneOfType([PropTypes.element, PropTypes.string]),
