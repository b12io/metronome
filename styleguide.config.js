...
module.exports = {
  ...
  styleguideComponents: {
    TableOfContentsRenderer: path.resolve(__dirname, 'styleguide/components/DemoLayoutNav.es6.js'),
    PathlineRenderer: path.resolve(__dirname, 'styleguide/components/MetaData.es6.js'),
    ComponentsListRenderer: path.resolve(__dirname, 'styleguide/components/ComponentList.es6.js'),
    SectionRenderer: path.resolve(__dirname, 'styleguide/components/Section.es6.js'),
    ReactComponentRenderer: path.resolve(__dirname, 'styleguide/components/ReactComponent.es6.js'),
  ...
  theme: {
    fontFamily: {
      base: ['SFUIText', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', 'sans-serif'],
