      ...
      <div className="app-page-title">
        ...
        <div className="ds-metadata">
          <div className="ds-metadata__di">
            ...
            <div className="ds-metadata__dd"><code>import Grid from '@b12/design-system/components/layout/grid/Grid'</code></div>
          </div>
          <div className="ds-metadata__di">
  ...
  <Button primary label="Get started" />
      ...
      <div className="app-page-title">
        ...
        <div className="ds-metadata">
          <div className="ds-metadata__di">
            <div className="ds-metadata__dt">Import</div>
            <div className="ds-metadata__dd"><code>import GridCol from '@b12/design-system/components/layout/grid/GridCol'</code></div>
          </div>
          <div className="ds-metadata__di">
            <div className="ds-metadata__dt">Dependencies</div>
