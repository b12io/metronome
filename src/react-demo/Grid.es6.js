...
function GridPage () {
  return (
    <DemoLayoutContent>
      <div className="app-page-title">
        <h1>Grid</h1>
        <p>
          This is a super-simple grid to properly distribute components in a
          row. Components inside grid will wrap if there is not enough space to
          fit in one line. Grid can contain columns.
        </p>
        <div className="ds-metadata">
          <div className="ds-metadata__di">
            <div className="ds-metadata__dt">Import</div>
            <div className="ds-metadata__dd">
              <code>
                import Grid from
                &apos;@b12/metronome/components/layout/grid/Grid.es6.js&apos;
              </code>
            </div>
          </div>
          <div className="ds-metadata__di">
  ...
  align-items: center;
          ...
          <p>
            You can also pass additional classes to the grid container using{' '}
  ...
  <Button label="Get started" />
        ...
        <CodeExample
          code={`<Grid nowrap justify="end" align="center">
  ...
  <Button primary label="Get started" />
        ...
        <table className="ds-table">
          ...
          <tbody>
            <tr>
              ...
              <td>
                Sets direction of the grid to column. Default is
                &apos;row&apos;.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>align</td>
              <td>
                <code>start</code> <code>end</code> <code>stretch</code>
              </td>
              <td>
                Aligns items vertically for row and horizontally for column
              </td>
            </tr>
            <tr>
              <td>nowrap</td>
      ...
      <div className="app-page-title">
        <h1>Grid column</h1>
        <p>
          Columns are used to divide content in a row. Grid can be nested inside
          a column
        </p>
        <div className="ds-metadata">
          <div className="ds-metadata__di">
            ...
            <div className="ds-metadata__dd">
              <code>
                import GridCol from
                &apos;@b12/metronome/components/layout/grid/GridCol.es6.js&apos;
              </code>
            </div>
          </div>
          <div className="ds-metadata__di">
      ...
      <div className="ds-block">
        <div className="ds-block__title">
          ...
          <p>
            We are using 12 column grid. Columns are aligned to center (x-axis)
            by default.
          </p>
        </div>

        <CodeExample
          code={`<Grid justify="between" align="center">
  ...
  <GridCol>I&apos;m a column with Lorem ipsum ...</GridCol>
        ...
        >
          <Grid justify="between" align="center">
            <GridCol col="3">I&apos;m a column</GridCol>
            <GridCol col="3" align="end">
              I&apos;m a column
            </GridCol>
            <GridCol>
              I&apos;m a column with Lorem ipsum dolor sit amet, consectetur
              adipiscing elit. In mollis rutrum aliquet. Vivamus quis porttitor
              justo, in congue urna. Donec vehicula, velit sit amet venenatis
              vulputate, nisi odio rhoncus elit, a venenatis velit risus ornare
              dui.
            </GridCol>
          </Grid>
        </CodeExample>
        ...
        <table className="ds-table">
          ...
          <tbody>
            <tr>
              ...
              <td>
                Sets width of a column. If no width provided, column will take
                up remaining space
              </td>
            </tr>
            <tr>
