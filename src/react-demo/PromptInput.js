...
`}>
          <PromptInput>
            ...
            <PromptInputSelectors>
              <Button roundedRectangle disabled={isProcessing || isRecording} iconWithLabel icon={<Website width={14} height={14} />} label="Website style" />
              <Button roundedRectangle disabled={isProcessing || isRecording} iconWithLabel icon={<EditColor width={14} height={14} />} label="Color" viewBox="0 0 14 14" />
              <Button roundedRectangle disabled={isProcessing || isRecording} iconWithLabel icon={<AiImage width={14} height={12} viewBox='0 0 14 12' />} label="Image style" />
              <Button
                roundedRectangle
