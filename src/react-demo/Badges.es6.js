...
<Badge label="Success" success/>`}
      ...
      <div className="ds-block">
        ...
        <CodeExample
          code={`<Badge label="Default" filled neutral/>
...
<Badge label="Success" success filled/>`}
      ...
      <div className="ds-block">
        ...
        <CodeExample
          code={`<Badge label="Default" filled neutral selected />
...
<Badge label="Success" success filled selected />`}
      ...
      <div className="ds-block">
        ...
        <CodeExample
          code={`<Badge label="Default" hasRemoveIcon/>
...
<Badge label="Success" success filled hasRemoveIcon/>`}
      ...
      <div className="ds-block">
        ...
        <CodeExample
          code={`<Badge label="Default" size="small" hasRemoveIcon/>
