...
function UtilitiesPage() {
  return (
    <DemoLayoutContent>
      <div className="app-page-title">
        <h1>Utilities</h1>
        <p>
          Classes and mixins that help combine and distribute components quickly
          and easily.
        </p>
      </div>
      <div className="ds-block">
        <div className="ds-block__title">
          <h4>Spacing</h4>
          <p>
            We use a range of shorthand margin and padding utility classes to
            modify an element&quot;s appearance. For example, if you want to set
            margin bottom to 5px for a div, add this class:{' '}
            <code>.dsu-mb-xxxxsm</code>
          </p>
          <p>
            The classes are named using the format <code>{text}</code> (
            <i>dsu</i> stands for <i>design-system-utility</i>)
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              <code>v</code> - vertical (top and bottom)
            </li>
            <li>
              <code>h</code> - horizontal (left and right)
            </li>
            <li>
              <code>a</code> - all sides
            </li>
          </ul>
          <p>
  ...
  'xxxlg':  50px
          ...
          <p>
            You can also use these sizes in SCSS by using this function:{' '}
            <code>spacing(&quot;size&quot;)</code>. Please check an example
            below:
          </p>
  ...
  padding: spacing('xsm'); // will be converted to 20px
        ...
        <CodeExample
          code={`<Button primary label="I am Groot" />
...
<Button label="I am Groot" className="dsu-ml-xxlg" />`}
  ...
  <Button label="I am Groot" block className="dsu-mt-sm" />
      ...
      <div className="ds-block">
        ...
        <ul>
          <li>
            <code>.dsu-hide</code> - applies <i>display: none</i>
          </li>
          <li>
            <code>.dsu-block</code> - applies <i>display: block</i>
          </li>
          <li>
            <code>.dsu-inline-block</code> - applies{' '}
